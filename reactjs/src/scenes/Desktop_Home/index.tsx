...
export interface IDesktop_HomeProps extends FormComponentProps,RouteComponentProps {
    userStore: UserStore;
}

export interface IDesktop_HomeState {
    userId: number;
}
...
@observer
class Desktop_Home extends AppComponentBase<IDesktop_HomeProps, IDesktop_HomeState> {
    formRef: any;
                    ...
                    <div className="container-fluid">
                        <div className="row">
                            <div className="col-lg-6 hidden-md">
                                ...
                                <NewsFeedsWithOutLogin {...this.props} />
...
export default Form.create()(Desktop_Home);